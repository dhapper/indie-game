...
public class Constants {
	...
	public static class MapConstants{
		...
		public static final int COLLISION_SPRITES = 2;
		public static final int OVERLAP_SPRITES = 1;
		
		public static final int[] LAYER_ORDER = {GROUND_SPRITES, OVERLAP_SPRITES, COLLISION_SPRITES};
