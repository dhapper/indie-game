...
public class EditorConstants {
	...
	public static class MapEditorConstants{
		...
		public static final int ENEMY_SPRITES = 4;
		
		public static final int[] LAYER_ORDER = {GROUND_SPRITES, ANIMATED_SPRITES, OVERLAP_SPRITES, COLLISION_SPRITES, ENEMY_SPRITES};
