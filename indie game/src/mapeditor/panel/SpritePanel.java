...
import mapeditor.SpriteSheetData;
...
public class SpritePanel extends Panel{
	...
	public SpritePanel(MapEditor mapEditor) {
		super(mapEditor);
	...
	public void paintComponent(Graphics g) {
	    ...
	    g.drawRect(Game.TILES_DEFAULT_SIZE * (SELECTED_SPRITE % spriteSheetData.getWidth()),
	    		Game.TILES_DEFAULT_SIZE * (SELECTED_SPRITE / spriteSheetData.getWidth()), Game.TILES_DEFAULT_SIZE, Game.TILES_DEFAULT_SIZE);
	    g.setColor(Color.WHITE);
	    g.drawRect(Game.TILES_DEFAULT_SIZE * (SELECTED_SPRITE % spriteSheetData.getWidth()) + 1,
	    		Game.TILES_DEFAULT_SIZE * (SELECTED_SPRITE / spriteSheetData.getWidth()) + 1, Game.TILES_DEFAULT_SIZE - 2, Game.TILES_DEFAULT_SIZE - 2);
